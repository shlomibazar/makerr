  ...
  <section class="gig-filter flex items-center filter-conteiner">
    ...
    <div class="flex">
      ...
      <div class="dropdown">
        ...
        <div
          class="budget-modal-container"
          v-if="isBudgetModal"
          v-click-outside="budgetModal"
        >
      ...
      <div class="dropdown">
        ...
        <div
          class="delivery-time-modal"
          v-if="this.isDeliveryModal"
          v-click-outside="deliveryTimeModal"
        >
